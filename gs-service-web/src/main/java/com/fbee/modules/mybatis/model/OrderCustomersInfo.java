...
public class OrderCustomersInfo {
    /**
    ...
    public String getSalaryTypeValue(){
        return DictionarysCacheUtils.getServicePriceUnit(this.getSalaryType());
    }
    ...
    public void setLanguageRequirements(String languageRequirements) {
        this.languageRequirements = languageRequirements == null ? null : languageRequirements.trim();
    }
    ...
    public void setPersonalityRequirements(String personalityRequirements) {
        this.personalityRequirements = personalityRequirements == null ? null : personalityRequirements.trim();
    }
    ...
    public void setWageRequirements(String wageRequirements) {
        this.wageRequirements = wageRequirements == null ? null : wageRequirements.trim();
    }
    ...
    public void setSalaryRequirements(String salaryRequirements) {
        this.salaryRequirements = salaryRequirements == null ? null : salaryRequirements.trim();
    }
