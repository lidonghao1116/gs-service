...
public class ReserveOrdersEntity extends ReserveOrders{
	...
	private ReserveOrdersCustomerInfo orderCustomer;
	...
	public ReserveOrdersCustomerInfo getOrderCustomer() {
		return orderCustomer;
	}

	public void setOrderCustomer(ReserveOrdersCustomerInfo orderCustomer) {
	...
	public String getSalarySkillsValue() {
		if(StringUtils.isNotBlank(orderCustomer.getSalarySkills())){
